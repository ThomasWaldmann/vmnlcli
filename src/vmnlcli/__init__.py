...
def create_parser():
    ...
    parser.add_argument(
        "--site", type=str, help="website to log in to, format: https://www.example.org"
    )
    ...
    parser.add_argument(
        "--vmid", metavar="VMID", type=int, default=0, help="ID of the velomobile"
    )
    ...
    update_parser.add_argument(
        ...
        type=str,
        default="YYYY-MM-DD",
        help="respective date for the overall km value (default: today)",
    )
    update_parser.add_argument(
        "distance",
        metavar="km",
        type=int,
        help="overall km value at the respective date",
    )
